          ...
          <div className="mt-8 space-y-8">
            {activeTab === "profile" ? (
              <section className="rounded-[2.5rem] bg-white p-6 shadow-xl shadow-emerald-100/60 ring-1 ring-white/60">
                ...
                <div className="mt-6 rounded-3xl bg-gray-50 p-4 text-sm text-gray-500">
                  Buyurtma tarixi tez orada bu yerda aks etadi. Hozircha menyudan tanlab buyurtma bering.
                </div>
              </section>
            ) : (
              <>
